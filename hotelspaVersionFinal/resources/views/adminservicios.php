    ...
    <div class="pushy-content">
        <ul>
            <li class="pushy-submenu">
                ...
                <ul>
                    <li class="pushy-link"><a href="#">Petición De Actividades</a></li>
                    <li class="pushy-link"><a href="#">Peticion De Servicios</a></li>
                </ul>
            </li>
            <li class="pushy-submenu">
        ...
        <div class="modal-content">
            ...
            <form class="push" method="POST" role="form" >
                ...
                <div class="modal-body">
                    ...
                    <input type="text" id="act" class="form-control1" placeholder="Actividad" name="act" value="">
                    </br>
                    ...
                    <input type="text" id="fecha" class="form-control1" placeholder="Fecha" name="fecha" value="">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
