    ...
    <form id="myform" class="push" method="POST" role="form" >
        ...
        <table class="table table-striped">
            ...
            <?php foreach($servicios as $servicio):?>
                <tr>
                    <td> <?=$servicio->user->dni?> </td>
                    <td> <?=$servicio->serv?> </td>
                    <td> <?=$servicio->habit?> </td>
                    <td> <?=$servicio->observaciones?> 
                    <td><button type="button" href="" class="btn btn-info"  name="btnBorrarCliente" onclick="abrirModal(this.id,'modificar')"  id="<?=$servicio['id']?>">Modificar</button>
                        <button type="button" href="" class="btn btn-danger" name="btnBorrarCliente" onclick="abrirModal(this.id,'borrar')"  id="<?=$servicio['id']?>">Borrar</button></td>
                </tr>
             <?php endforeach?>
            </tbody>
        </table>
        ...
        <div class="modal-content">
            ...
            <form class="push" method="POST" role="form" >
                ...
                <div class="modal-body">
                    ...
                    <label class="col-md-2 control-label">serv</label>
                    <input type="text" id="tipo" class="form-control1" placeholder="Servicio" name="tipo" value="">
                    </br>
                    ...
                    <input type="text" id="mod" class="form-control1" placeholder="Observaciones" name="mod" value="">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
